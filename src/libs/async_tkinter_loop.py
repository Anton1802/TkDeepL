...
async def main_loop(root: tkinter.Tk, title: str) -> None:
    """
...
def async_mainloop(root: tkinter.Tk, title: str) -> None:
    """
    A synchronous function to run asynchronous main_loop function
    :param root: tkinter root object
    :return: nothing
    """
    _get_event_loop().run_until_complete(main_loop(root, title))
